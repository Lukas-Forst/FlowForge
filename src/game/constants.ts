...
export const UPGRADE_OPTIONS: Record<UpgradeOption["type"], UpgradeOption> = {
  ...
  projectileCount: {
    ...
    label: "Twin Cannons",
    description: "Add an extra forward auto-shot.",
    rarity: "uncommon",
    maxStacks: 3,
  },
  sideGuns: {
    type: "sideGuns",
    label: "Broadside Volley",
    description: "Passive port and starboard shots.",
    rarity: "uncommon",
    maxStacks: 2,
  },
  pierce: {
    ...
    description: "Auto-shots pierce 1 extra enemy.",
    rarity: "uncommon",
    maxStacks: 2,
  },
  coinMagnet: {
  ...
  boostRepeat: {
    type: "boostRepeat",
    label: "Second Wind",
    description: "Boost cooldown -40%, active time +50%.",
    rarity: "rare",
    maxStacks: 1,
  },
  cannonSpread: {
    ...
    description: "Cannon salvo size +2, wider arc.",
    rarity: "rare",
    maxStacks: 2,
  },
  fullSteam: {
    type: "fullSteam",
    label: "Full Steam Ahead",
    description: "Auto-fire doubled while boost is active.",
    rarity: "epic",
    maxStacks: 1,
  },
};
